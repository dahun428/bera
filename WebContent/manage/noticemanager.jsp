...
<%
	...
	if ("title".equals(searchOption)) {
		...
		notices = noticeDao.getPaginatedNoticeByTitle(pagenation.getBeginIndex(), pagenation.getEndIndex(),
				searchValue);
	} else if ("content".equals(searchOption)) {
		totalRows = noticeDao.getTotalByContent(searchValue);
		pagenation = new Pagenation(10, 5, pageNo, totalRows);
		notices = noticeDao.getPaginatedNoticeByContent(pagenation.getBeginIndex(), pagenation.getEndIndex(),
				searchValue);
	} else {
													...
													<div class="card">
														<div class="card-body">
															...
															<div class="row">
																<!-- 검색조건 입력폼 시작 -->
																<div class="col-6">
																	<form action="noticemanager.jsp" method="get">
																...
																<div class="col-6">
																	<div class="row">
																		...
																		<div class="col-12 text-right">
																			<a href="noticemanager-noticeform.jsp"
																...
																<tbody>
																	...
																	<tr>
																		...
																		<td><a class="font-weight-bold"
																			href="noticemanager-detail.jsp?no=<%=noticeImp.getNo()%>"><%=noticeImp.getTitle()%></a></td>
																	...
																	<tr>
																		...
																		<td><a style="text-decoration: none;"
																			href="noticemanager-detail.jsp?no=<%=notice.getNo()%>"><%=notice.getTitle()%></a></td>
															...
															<ul class="pagination justify-content-center"
																...
																<li class="page-item"><a class="page-link"
																	href="noticemanager.jsp?page=<%=pagenation.getPageNo() - 1%>">이전</a></li>
																<%
																	}
																...
																<li class="page-item"><a
																	...
																	href="noticemanager.jsp?page=<%=num%>"><%=num%></a></li>
																...
																%>
																<li class="page-item"><a class="page-link"
																	href="noticemanager.jsp?page=<%=pagenation.getPageNo() + 1 %>">다음</a></li>
																<%
												}
											%>
															</ul>
