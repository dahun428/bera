...
public class UserDao {
	 ...
	 * @throws SQLException
	 */
	public List<PointUse> getPointUseByUserId(String userId, int startNo, int endNo) throws SQLException {
	...
	public int getTotalPointRows(String userId) throws SQLException {
		int totalRows = 0;
		
		Connection connection = ConnectionUtil.getConnection();
		PreparedStatement pstmt = connection.prepareStatement(QueryUtil.getSQL("user.getTotalPointRows"));
		pstmt.setString(1, userId);
		ResultSet rs = pstmt.executeQuery();
		rs.next();
