																	...
																	<tr>
																		<td class="custom-event-box">
																			...
																			<div class=" text-center">
																				<img
																					src="../image/NOTICE/<%=notice.getImagePath()%>"
																					alt="" />
																			</div> <%
 	}
 %>
												...
												<div class="col-12 text-center">
													<hr />
													<a href="noticemanager.jsp" class="btn btn-outline-primary btn-lg">목록으로</a>
												</div>
												...
												<div class="col-12 text-right">
													<a href="../notice/delete.jsp?no=<%=notice.getNo()%>"
														class="btn btn-secondary">삭제</a> <a
														href="noticemanager-modifyform.jsp?no=<%=notice.getNo()%>"
