				...
				<div class="custom-content-box">
					...
					<div class="row content-header text-center">
						...
						<div class="col-9 custom-border-right">
							<h2 class="text-info">안녕하세요 <%=loginedUserName %>님</h2>
						</div>
						<div class="col-3">
							<h5>사용가능 총 포인트</h5>
							...
							<div class="col-12">
								...
								<div class="row orderlist">
									<table class="table table-bordered text-center">
										...
										%>
											<tr>
												<td colspan="7" class="text-center">장바구니에 상품이 없습니다.</td>
											</tr>
										<%
											} else {
										...
										%>
											<tr>
												...
												<td>
													<button type="button" class="btn btn-primary" onclick="AllCheckDelete(); check('../order/credit.jsp?productNo=<%=basketDto.getNo() %>&amount=<%=basketDto.getAmount() %>&buyType=cart&type=one', 'one')">구매하기</button>
												</td>
											</tr>
										<%
												}
