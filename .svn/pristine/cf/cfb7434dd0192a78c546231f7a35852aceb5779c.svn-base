											...
											<tr>
												...
												<td>
													<div class="form-group" id="tel-input">
														<input id="phone-id" name="tel" maxlength="13" type="text" class="form-control" value="<%=user.getPhone() %>"/>
													</div>
												</td>
											</tr>
											<tr>
												...
												<td>
													<div class="form-group" id="email-input">
														<input id="email-id" name="email" type="text" class="form-control" value="<%=user.getEmail() %>"/>
													</div>
