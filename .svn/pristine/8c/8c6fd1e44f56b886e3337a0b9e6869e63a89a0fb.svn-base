...
<body>
											...
											<td>
												<p>
													<input type="number" value="<%=productAmount %>"
														class="form-control text-right" id="amount-input-<%=productNoList[i] %>" min="1" onchange="changeAmount(<%=productNoList[i] %>)" onkeyup="this.value=this.value.replace(/[^0-9]/g,'');"/>
												</p>
											</td>
											<td>
	...
	<script type="text/javascript">
		...
		function changeAmount(productNo) {
			...
			digitCheck(document.getElementById("amount-input-" + productNo));
