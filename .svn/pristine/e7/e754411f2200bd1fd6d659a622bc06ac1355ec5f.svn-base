							...
							<div class="col-12">
								...
								<div class="container">
									...
									<div class="custom-content-box">
										<form action="../notice/noticeupdate.jsp" method="post"
												...
												<tbody>
														...
														<td colspan="4">
															<div class="input-group">
																<input type="text" class="form-control"
																	...
																	id="notice-title" value="<%=notice.getTitle()%>" />
																<div class="input-group-prepend">
																	<div class="input-group-text">
																		<input type="radio" name="noticeValue"
																			checked="<%="0".equals(notice.getImportant()) ? "checked" : " "%>"
																			value="0" /><span>중요공지</span> <input
																			type="radio" name="noticeValue"
																			checked="<%="1".equals(notice.getImportant()) ? "checked" : " "%>"
																			value="1" /><span>일반공지</span>
																	</div>
																</div>
															</div>
														</td>
														...
														<td colspan="4">
															<div class="text-left">
																<button class="btn btn-primary" type="button"
																	id="notice-image-delete-btn">이미지 삭제</button>
															</div>
														</td>
													</tr>
													<%
													...
													<tr>
														<td colspan="4">
															...
															%>
															<div>
																<img src="../image/NOTICE/<%=notice.getImagePath()%>"
																	class="card-img" id="change-image" alt="...">
															</div> <%
 	} else {
 %>
															<div>
																<img name="blank_img" src="../image/no_detail_img.jpg"
																	class="card-img" id="change-image" alt="...">
															</div> <%
 	}
 %>
													...
													<tr>
														<td colspan="4"><textarea class="form-control"
																...
																name="content" maxlength="2048" style="height: 100px;" /><%=notice.getContent()%></textarea>
														</td>
													</tr>
												</tbody>
											</table>
