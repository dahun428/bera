...
<body>
	<div class="container">
		...
		%>
			<div class="col-1">
				<a href="${pageContext.request.contextPath }/manage/main.jsp"
		...
		%>
			<div class="col-9">
				<ul class="nav justify-content-end" id="custom-nav">
					<li class="nav-item"><a class="nav-link <%="flavor".equals(position) ? "active" : "" %>" href="${pageContext.request.contextPath }/product/search.jsp">Search</a>
						<div class="nav-sub">
							<div class="nav-sub-menu">
								<a href="${pageContext.request.contextPath }/event/list.jsp">
								<img
							...
							<ul class="nav-sub-menu">
								<li><a
									href="${pageContext.request.contextPath }/event/list.jsp">진행중인
										이벤트</a></li>
								<li><a
									href="${pageContext.request.contextPath }/event/end.jsp">종료된 이벤트</a></li>
							</ul>
						</div></li>
					<li class="nav-item"><a
