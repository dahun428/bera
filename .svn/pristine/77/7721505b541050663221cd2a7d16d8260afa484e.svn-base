					...
					<div class="custom-box-wrap">
						<div class="custom-box">
										...
										<tr>
											...
											<td>
												<div id='id-input' class="form-group">
													<input id="id-id" name="id" type="text" class="form-control" />
												</div>
												<p style="margin: 0; color: red; font-size: 13px;" id="id-error-text"></p>
											</td>
										</tr>
										<tr>
											<td>비밀번호</td>
											<td>
												<div id='pwd-input'class="form-group">
													<input id="pwd-id" name="pwd" type="password" class="form-control" />
												</div>
											</td>
										</tr>
										<tr>
											...
											<td>
												<div id='pwd-chk-input'class="form-group">
													<input id="pwd-chk-id" name="pwd-chk" type="password" class="form-control" onkeyup="pwdCheck()"/>
													<p style="margin: 0; color: red; font-size: 13px;" id="pwd-error-text"></p>
												</div>
											</td>
										</tr>
										<tr>
											...
											<td>
												<div id='phone-input'class="form-group">
													<input id="phone-id" name="phone" type="text" maxlength="13" class="form-control phoneNumber" />
												</div>
											</td>
										</tr>
										<tr>
											...
											<td>
												<div id='email-input'class="form-group">
													<input id="email-id" name="email" type="text" class="form-control" />
												</div>
												<p style="margin: 0; color: red; font-size: 13px;" id="email-error-text"></p>
											</td>
										</tr>
										<tr>
											<td colspan="2">
							...
							<div class="form-btn text-right">
								...
								<button id="submit-button" type="submit" class="btn btn-primary">회원가입</button>
							</div>
							</form>
						</div>
					</div>
...
<script type="text/javascript">
	function checkField(event) {
		...
		var pwdError = document.getElementById("pwd-error-text");
		var idError = document.getElementById("id-error-text");
		...
		if(!(id >= '0' && id <= '9') && !(id >= 'a' && id <= 'z')&&!(id >= 'A' && id <= 'Z')) {
			idError.textContent = "아이디는 영문 대소문자, 숫자만 입력가능합니다"
			isPassed = false;
		}
	...
	function pwdCheck() {
		...
		var pwdChk = document.getElementById("pwd-chk-id").value;
		var errorText = document.getElementById("pwd-error-text");
	...
	$("#phone-id").on("keyup", function() { $(this).val( $(this).val().replace(/[^0-9]/g, "").replace(/(^02|^0505|^1[0-9]{3}|^0[0-9]{2})([0-9]+)?([0-9]{4})$/,"$1-$2-$3").replace("--", "-") ); });
</script>
</body>
</html>